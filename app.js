...
function doseSheet(open = false) { return `<section id="doseDoneSheet" class="bottomSheet ${open ? 'open' : ''}"><div class="grab"></div><div class="sectionTitle"><h3>选择明日剂量</h3><small>记录服药完成时间后确认</small></div><div class="choiceGrid"><button class="choice on"><b>按计划服用</b><span>明日 1.5 片</span></button><button class="choice"><b>手动输入</b><span>输入片或毫克</span></button></div></section>`; }
